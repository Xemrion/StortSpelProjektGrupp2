...
public:
	...
	btRigidBody* addSphere(float radius, btVector3 Origin, float mass, GameObjectBase* obj = nullptr);
	btRigidBody* addBox(btVector3 Origin, btVector3 size, float mass, GameObjectBase* obj = nullptr);
