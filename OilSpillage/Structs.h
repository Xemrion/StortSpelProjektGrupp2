...
struct AABB
{
	...
	{
		AABB scaledAABB = { DirectX::SimpleMath::Vector3(minPos.x * scale.x, minPos.y * scale.y, minPos.z * scale.z), DirectX::SimpleMath::Vector3(maxPos.x * scale.x,maxPos.y * scale.y,maxPos.z * scale.z) };
		return scaledAABB;
	};
