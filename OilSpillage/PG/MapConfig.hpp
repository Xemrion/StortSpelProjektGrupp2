...
struct MapConfig {
	...
	I32   roadDepthMax                   {       4 };
	F32   roadMinTotalCoverage           {   .25f }; // TODO: add to imgui window
	F32   roadMaxTotalCoverage           {   .500f }; // TODO: add to imgui window
	F32   roadLengthFactorMin            {   .050f };
	F32   roadLengthFactorMax            {   .100f };
