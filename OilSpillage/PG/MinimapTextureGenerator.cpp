...
String createMinimapTexture( Map const &map ) {
	...
	Vector<RGBA> districtColors(static_cast<Size>(District::size));
					 districtColors[static_cast<Size>(District::residential )] = 0xFF'00FFFF;
					 districtColors[static_cast<Size>(District::park        )] = 0xFF'00FF00;
					 districtColors[static_cast<Size>(District::metropolitan)] = 0xFF'0000FF;
					 districtColors[static_cast<Size>(District::suburban    )] = 0xFF'FFFF00;
					 districtColors[static_cast<Size>(District::downtown    )] = 0xFF'FF0000;
   ...
   auto generateGroundColor {
		[&generateSelection,&rng]( RGBA districtColor ) {
			RGBA groundColor;
   ...
   for ( U16 tileY = 0;  tileY < tilemap.height;  ++tileY ) {
      for ( U16 tileX = 0;  tileX < tilemap.width;  ++tileX ) {
			RGBA districtColor = districtColors[ static_cast<Size>(map.getDistrictAt(tileX,tileY))];
