...
void UICompletedStage::init()
{
	...
	this->textStats[0]->setPosition(Vector2(SCREEN_WIDTH / 2 - this->textStats[0]->getLength(16) + 120, 170 + offset * 0));
	...
	this->textStats[1]->setPosition(Vector2(SCREEN_WIDTH / 2 - this->textStats[1]->getLength(20) + 120, 170 + offset * 1));
	...
	this->textStats[2]->setPosition(Vector2(SCREEN_WIDTH / 2 - this->textStats[2]->getLength(15) + 120, 170 + offset * 2));
	...
	this->textStats[3]->setPosition(Vector2(SCREEN_WIDTH / 2 - this->textStats[3]->getLength(18) + 120, 170 + offset * 3));
	...
	this->textStats[4]->setPosition(Vector2(SCREEN_WIDTH / 2 - this->textStats[4]->getLength(16) + 120, 170 + offset * 4));
	...
	this->textStats[5]->setPosition(Vector2(SCREEN_WIDTH / 2 - this->textStats[5]->getLength(19) + 120, 170 + offset * 5));
	...
	this->textStats[6]->setPosition(Vector2(SCREEN_WIDTH / 2 - this->textStats[6]->getLength(13) + 120, 170 + offset * 6));
